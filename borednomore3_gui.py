...
class BoredMissionControl(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        # --- Sidebar ---
        self.side = ctk.CTkFrame(self, width=340, corner_radius=0, fg_color="#111827")
        ...
        config_f.pack(fill="x", padx=25, pady=(5, 10))
        ...
        self.config_entry.pack(side="left", expand=True, fill="x", padx=(0, 5))
       
        self.config_browse_btn = ctk.CTkButton(
            config_input_f, text="📁", width=32, height=32,
        ...
        config_btn_f.pack(fill="x", padx=25, pady=(0, 15))
       
        self.load_config_btn = ctk.CTkButton(
            config_btn_f, text="LOAD CONFIG",
            height=28, fg_color="#1E293B",
            hover_color="#3B82F6",
            font=ctk.CTkFont(size=10),
            command=self.load_configuration
        )
        self.load_config_btn.pack(side="left", expand=True, fill="x", padx=(0, 3))
        ...
        self.browse_btn = ctk.CTkButton(
            folder_input_f, text="📂", width=35, height=35,
            fg_color="#374151", hover_color="#3B82F6",
            command=self.browse
        )
        ...
        binary_f.pack(fill="x", padx=25, pady=(8, 10))
        ...
        # Red "End Program" button - exits GUI, keeps backend running
        self.end_program_btn = ctk.CTkButton(
            self.side, text="End Program",
            height=45, fg_color="#EF4444",
            hover_color="#B91C1C",
            font=ctk.CTkFont(weight="bold"),
            command=self.end_program
        )
        self.end_program_btn.pack(side="bottom", padx=25, pady=20, fill="x")
        ...
        for label, flag in [("VERSION", "-v"), ("CREDITS", "-c"), ("HELP", "-h")]:
            b = ctk.CTkButton(
                self.cmd_bar, text=label, width=90, height=30,
        ...
        self.all_btn = ctk.CTkButton(
            ...
            width=80, height=24, fg_color="#1E293B",
            hover_color="#3B82F6",
            font=ctk.CTkFont(size=10),
        ...
        self.none_btn = ctk.CTkButton(
            self.util_f, text="CLEAR",
            width=60, height=24, fg_color="#1E293B",
            hover_color="#EF4444",
            font=ctk.CTkFont(size=10),
        ...
        for i in range(1, 101):
            ...
            cb.grid(row=(i-1) // 5, column=(i-1) % 5, padx=8, pady=8, sticky="w")
    ...
    # NEW: End Program method (closes GUI, keeps backend running)
    def end_program(self):
        """End Program - close GUI but keep backend running if active"""
        self.on_closing()
